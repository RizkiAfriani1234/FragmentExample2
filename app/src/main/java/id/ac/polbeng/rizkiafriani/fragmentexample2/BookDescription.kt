package id.ac.polbeng.rizkiafriani.fragmentexample2
...
import id.ac.polbeng.rizkiafriani.fragmentexample2.databinding.BooDescriptionBinding

class BookDescription : Fragment()  {

    private var _binding: BooDescriptionBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = BooDescriptionBinding.inflate(inflater, container,
            false)
